...
<div class="content home">
	...
	<a href="login.php" class="upload-image">Login</a>
        <a href="logout.php" class="upload-image">Sign Out</a>
        <a href="reset-password.php" class="upload-image">Reset Password</a>
